...
template <> constexpr inline auto MainWindow::qt_create_metaobjectdata<qt_meta_tag_ZN10MainWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onCANFrameReceived'
        QtMocHelpers::SlotData<void(const RoboLink::CANFrame &)>(8, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 9, 10 },
        }}),
        // Slot 'onLogMessage'
...
void MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->onSendTestFrameClicked(); break;
        case 3: _t->onClearLogClicked(); break;
        case 4: _t->onConnectionChanged((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 5: _t->onCANFrameReceived((*reinterpret_cast< std::add_pointer_t<RoboLink::CANFrame>>(_a[1]))); break;
